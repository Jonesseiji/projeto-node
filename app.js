...
server.get("/download/images/:imageName", (req, res) => {
    res.download(path.join("public", "images", req.params.imageName)); //faz o download da im"agem no caminho localhost:3000/download/static/images/nome da imagem.extensão(jpg,png)
});
